...
export const auth = {
  ...
  resetPassword: {
    ...
    requestDescription: "가입한 이메일을 입력하면 재설정 안내를 준비합니다.",
    requestAction: "재설정 링크 요청",
    requestSuccessTitle: "요청을 확인했습니다",
    requestSuccessDescription:
      "계정이 있다면 비밀번호 재설정 안내를 받을 수 있어요.",
    devResetLink: "개발용 재설정 링크 열기",
    completeTitle: "새 비밀번호 설정",
    completeDescription: "새 비밀번호를 입력해 계정을 다시 보호하세요.",
    completeAction: "비밀번호 변경",
    completeSuccessTitle: "비밀번호가 변경됐습니다",
    completeSuccessDescription: "이제 새 비밀번호로 로그인할 수 있어요.",
    invalidTokenTitle: "재설정 링크가 올바르지 않습니다",
    invalidTokenDescription: "링크가 만료됐거나 이미 사용됐을 수 있어요.",
    loginAction: "로그인으로 이동",
  },
  or: "또는",
  terms: "이용약관",
